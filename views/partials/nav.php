          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/notes" class="<?= urlIs("/notes") ? "bg-gray-900 text-white" : "text-gray-300" ?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Notes</a>
                    <a href="/chatroom" class="<?= urlIs("/chatroom") ? "bg-gray-900 text-white" : "text-gray-300" ?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Chatrooms</a>
                <?php endif; ?>
              ...
              <a href="/contact" class="<?= urlIs("/contact") ? "bg-gray-900 text-white" : "text-gray-300" ?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Contact</a>
                <a href="/users" class="<?= urlIs("/users") ? "bg-gray-900 text-white" : "text-gray-300" ?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Users</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <!-- Profile dropdown -->
            <div class="relative flex items-center gap-2 ml-3">
              <div>
...
<!--                </button>-->
                ...
                <?php if ($_SESSION['user'] ?? false) : ?>
                <form method="POST" action="/session" class="mb-0">
